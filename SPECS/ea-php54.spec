...
BuildRequires: bzip2-devel, %{ns_name}-libcurl >= %{ea_libcurl_ver}, %{ns_name}-libcurl-devel >= %{ea_libcurl_ver}, %{db_devel}, gmp-devel
...
%description
php 5.4 has reached End of Life.

%if %{with_httpd}
Package that installs Apache`s mod_php DSO module for PHP 5.4
%else
...
%if %{with_mssql}
%package mssql
Summary: EOL MSSQL database module for PHP
Group: Development/Languages
# All files licensed under PHP version 3.01
License: PHP
Requires: %{?scl_prefix}php-pdo = %{version}-%{release}
...
ln -sf /opt/cpanel/ea-php54/root/usr/bin/php $RPM_BUILD_ROOT/usr/local/bin/ea-php54
install -d $RPM_BUILD_ROOT/usr/bin
ln -sf /opt/cpanel/ea-php54/root/usr/bin/php-cgi $RPM_BUILD_ROOT/usr/bin/ea-php54
...
%changelog
* Wed Apr 08 2026 Brian Mendoza <brian.mendoza@webpros.com> - 5.4.45-82
- EA4-173: Mark ea-scl-php54 as EOL

* Tue Oct 14 2025 Chris Castillo <chris.castillo@webpros.com> - 5.4.45-81
- EA4-136: Fix libxml2 v2.15.0 compatibility

* Fri Sep 13 2024 Julian Brown <julian.brown@cpanel.net> - 5.4.45-80
...
* Tue Dec 28 2021 Dan Muey <dan@cpanel.net> - 5.4.45-75
- ZC-9589: Update DISABLE_BUILD to match OBS

* Mon Jun 28 2021 Travis Holloway <t.holloway@cpanel.net> - 5.4.45-74
- EA-9013: Disable %check section

* Fri Mar 05 2021 Cory McIntire <cory@cpanel.net> - 5.4.45-73
- EA-9625: Update litespeed to 7.9

* Wed Oct 28 2020 Tim Mullin <tim@cpanel.net> - 5.4.45-72
- EA-9390: Fix build with latest ea-brotli (v1.0.9)

* Fri Sep 04 2020 Tim Mullin <tim@cpanel.net> - 5.4.45-71
- EA-9281: Update litespeed from upstream to 7.8

* Fri Jul 24 2020 Tim Mullin <tim@cpanel.net> - 5.4.45-70
- EA-9189: Update litespeed from upstream to 7.7

* Thu Mar 26 2020 Tim Mullin <tim@cpanel.net> - 5.4.45-69
- EA-8928: Updated the required version for ea-libcurl

* Thu Mar 05 2020 Daniel Muey <dan@cpanel.net> - 5.4.45-68
- ZC-6270: Fix circular deps like EA-8854

* Tue Mar 03 2020 Julian Brown <julian.brown@cpanel.net> - 5.4.45-67
- ZC-6247: Remove multiple conflicts between php-fpm and other rpms

* Fri Nov 22 2019 Tim Mullin <tim@cpanel.net> - 5.4.45-66
...
* Mon Jul 22 2019 Cory McIntire <cory@cpanel.net> - 5.4.45-63
- EA-8576: Update litespeed from upstream to 7.5

* Mon Jul 08 2019 Cory McIntire <cory@cpanel.net> - 5.4.45-62
- EA-8558: Update litespeed from upstream to 7.4.2

* Fri Jun 21 2019 Tim Mullin <tim@cpanel.net> - 5.4.45-61
- EA-8538: Update litespeed from upstream to 7.4

* Thu Apr 25 2019 Daniel Muey <dan@cpanel.net> - 5.4.45-60
- ZC-5036: Add find-latest-version (assumes PHP is checked out next ro ea-tools)

* Mon Apr 22 2019 Tim Mullin <tim@cpanel.net> - 5.4.45-59
- EA-8342: Update litespeed to new upstream update of 7.3

* Tue Apr 16 2019 Tim Mullin <tim@cpanel.net> - 5.4.45-58
- EA-8342: Update litespeed to 7.3

* Fri Jan 25 2019 Cory McIntire <cory@cpanel.net> - 5.4.45-57
- Update litespeed to the lastest version (7.2)

* Wed Jul 18 2018 Tim Mullin <tim@cpanel.net> - 5.4.45-56
- Fixed php-fpm installing directories it does not own (EA-7526)

* Tue Jun 5 2018 Rishwanth Yeddula <rish@cpanel.net> - 5.4.45-55
- EA-7359: Ensure ea-libxml2 is listed as a requirement for the php-xml package.

* Wed Apr 18 2018 Cory McIntire <cory@cpanel.net> - 5.4.45-54
- ZC-3600: Update litespeed to the latest version (7.1).
...
* Tue Jul 25 2017 Dan Muey <dan@cpanel.net> - 5.4.45-39
- EA-6574: Make permissions on FPM socket dir more secure

* Wed Jun 28 2017 Dan Muey <dan@cpanel.net> - 5.4.45-38
- EA-6484: Clarify Summary and Description for DSO

* Thu Jun 22 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.4.45-37
- EA-6232: Build -curl with HTTP/2 support

* Wed May 17 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.4.45-36
- Switch libxml2 to OS provided libraries

* Tue May 16 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.4.45-35
- EA-6282: Swapped ea-php## symlinks to match EasyApache 3 compatibility

* Tue May 09 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.4.45-34
...
* Thu Nov 17 2016 S. Kurt Newman <kurt.newman@cpanel.net> - 5.4.45-23
...
* Thu Sep 01 2016 S. Kurt Newman <kurt.newman@cpanel.net> - 5.4.45-20
...
* Tue Mar 17 2015 S. Kurt Newman <kurt.newman@cpanel.net> - 5.4.38-0
- Upgrade to PHP 5.4.38
- Made compatible with EA4 web server

* Thu Oct 23 2014 Jan Kaluza <jkaluza@redhat.com> - 5.4.16-22
- fileinfo: fix out-of-bounds read in elf note headers. CVE-2014-3710

* Mon Oct 20 2014 Remi Collet <rcollet@redhat.com> - 5.4.16-20
- xmlrpc: fix out-of-bounds read flaw in mkgmtime() CVE-2014-3668
- core: fix integer overflow in unserialize() CVE-2014-3669
- exif: fix heap corruption issue in exif_thumbnail() CVE-2014-3670

* Tue Oct  7 2014 Remi Collet <rcollet@redhat.com> - 5.4.16-18
...
- fileinfo: fix infinite recursion. CVE-2014-1943
